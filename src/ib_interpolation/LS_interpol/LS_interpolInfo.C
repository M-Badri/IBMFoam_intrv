...
//---------------------------------------------------------------------------//
LS_interpolInfo::LS_interpolInfo
(
    const  fvMesh&   mesh,
...
{}
//---------------------------------------------------------------------------//
void LS_interpolInfo::setIntpInfo()
{
...
//---------------------------------------------------------------------------//
void LS_interpolInfo::getInvDirichletMatrix
(
...
//---------------------------------------------------------------------------//
void LS_interpolInfo::getIbCellsFaces
(
    const DynamicLabelList& ibCells
)
{
...
//---------------------------------------------------------------------------//
void LS_interpolInfo::findCellCells
(
    const label cellId,
    labelList& cellCells,
    scalar& centerMeanDist
...
//---------------------------------------------------------------------------//
scalarSquareMatrix LS_interpolInfo::LUinvert
(
